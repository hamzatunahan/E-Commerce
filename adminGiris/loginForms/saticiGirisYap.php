...
<div class="card bg-dark text-white p-5" id="marg" style="width: 25rem;">
    <h1 class="card-title text-center">Kullanıcı Adı ve Şifrenizle Satıcı Paneline Girişinizi Yapınız.</h1>
    <div class="card-body">
        <form class="form-group" action="../saticiLogin.php" method="POST">
